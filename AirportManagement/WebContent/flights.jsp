...
<%!String query;
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
			<h3 class="heading-agileinfo">Add  <span>Flights</span></h3>
		</div>
            ...
            <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="flight_name" name="flight_name" placeholder="Flight Name" tabindex="1">
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="form-label" id="nameLabel" for="name"></label>
                        <input type="text" class="form-control" id="flight_time" name="flight_time" placeholder="Flight Timings" tabindex="1">
                    </div> 
                     <div class="form-group">
                        <label class="form-label" id="nameLabel" for="name"></label>
                        <input type="text" class="form-control" id="flight_price" name="flight_price" placeholder="Price" tabindex="1">
                    </div> 
                    <div class="text-center mt-5">
                        <button type="submit" id="submit" name="submit" class="serv_bottom btn btn-border btn-lg w-100">Add Flights</button>
                    </div>
                </form>
            </div>
 ...
 <%
        if (request.getParameter("submit")!=null) {
            ...
            String flight_price=request.getParameter("flight_price");
            String flight_time=request.getParameter("flight_time");
            String sourceId=request.getParameter("sourceId");
            String destinationId=request.getParameter("destinationId");
            String query = "insert into flights_tbl (flightName,timings,price,source,destination) "
            			+"values ('"+flight_name+"','"+flight_time+"','"+flight_price+"','"+sourceId+"','"+destinationId+"')";
            System.out.println(query);
            DAO_Implement dao = new DAO_Implement();
            if (dao.putData(query)>0) {
                %>
                <script type = "text/javascript">
                    alert("Flights Details Has been Sucessfully Added");
                ...
                %>
                <script type="text/javascript">
                    alert("Flights Details Has Not been Added");
                    window.location.href = "flights.jsp";
                </script>
                <%
            }
