...
<%!String query;
    ...
    <div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
			<h3 class="heading-agileinfo">Add  <span>Staff</span></h3>
		</div>
            ...
            <div class="col-md-6">
                <form id="contact-form" name="myForm" class="form" action="#" onsubmit="return validateForm()" method="POST">
									...
									<%
										query = "select * from airports_tbl";
											...
											while (resultSet.next()) {
												...
												int id = resultSet.getInt("airportId");
									%>
									<option value="<%=id%>"><%=airportname%></option>
									<%
										}
									%>
							</select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="designation" name="designation" placeholder="Designation" tabindex="3">
                    </div>
               
                    <div class="text-center mt-5">
                        <button type="submit" id="submit" name="submit" class="serv_bottom btn btn-border btn-lg w-100">Add Staff</button>
                    </div>
                </form>
            </div>
...
<%
        if (request.getParameter("submit")!=null) {
            ...
            String query = "insert into staffs_tbl (airportId,designation,staffName) "
            			+"values ("+airportid+",'"+designation+"','"+staffname+"')";
