    ...
    <!-- //banner -->
     ...
     <div class="container py-lg-5 mt-sm-5 mt-3">
		...
		<div class="w3ls-titles text-center mb-5">
			<h3 class="heading-agileinfo">View<span>Flights</span></h3>
		</div>
        ...
        <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <td style="color: #990000; font-size: 17px; font-weight: bold;">FlightId</td>
                                ...
                                <td style="color: #990000; font-size: 17px; font-weight: bold;">Flight Timings
                                </td>
                        ...
                        <%
                        DAO_Implement dao = new DAO_Implement();
                        String query = "SELECT * FROM  flights_tbl";
                        ResultSet result = dao.getData(query);

                        while (result.next()) {
                            // output data of each row
                                int id = result.getInt("flightId");
                                String flightname = result.getString("flightName");
                                String scheduledate = result.getString("timings");
